...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_GAME_OVERWATCH] = LAYOUT_split_3x6_3(
        ...
        KC_B,     KC_RSFT,  KC_Z,     KC_X,     KC_C,     KC_V,               KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,  RSFT_T(KC_ENT),
    ...
    [_LOWER] = LAYOUT_split_3x6_3(
        //_______,  DF(_QWERTY),  DF(_COLEMAK_DH),  _______, _______, _______,  KC_AMPR,  KC_UNDS,  KC_LBRC,  KC_RBRC,  KC_PERC,  UK_CLEAR,
        _______,  KC_EXLM,  KC_AT,    KC_HASH,  KC_DLR,   KC_PERC,            KC_CIRC,  KC_AMPR,  KC_ASTR,  KC_LPRN,  KC_RPRN,  _______,
        _______,  KC_EXLM,  KC_MINS,  KC_PLUS,  KC_EQL ,  KC_HASH,            KC_PIPE,  KC_COLN,  KC_LPRN,  KC_RPRN,  KC_QUES,  _______,
        _______,  KC_BSLS,  KC_SLSH,  KC_ASTR,  KC_CIRC,  KC_TILD,            KC_TILD,  KC_DLR ,  KC_LCBR,  KC_RCBR,  KC_AT,    _______,
    ...
    [_FUNC] = LAYOUT_split_3x6_3(
        ...
        _______,  OSM_LGUI, OSM_LALT, OSM_LSFT, OSM_LCTL, _______,            _______,  KC_F4,    KC_F5,    KC_F6,    KC_F11,   _______,
...
bool combo_should_trigger(uint16_t combo_index, combo_t *combo, uint16_t keycode, keyrecord_t *record) {
    if (layer_state_cmp(layer_state | default_layer_state, _GAME_OVERWATCH) ||
        layer_state_cmp(layer_state | default_layer_state, _GAME_DIABLO3) ||
